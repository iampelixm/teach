...
<main>
    <div class="container">
        ...
        <button class="btn btn-info" data-toggle="collapse" data-target="#course_form" aria-expanded="false" aria-controls="course_form">Описние</button>
        <button class="btn btn-info ml-2" data-toggle="collapse" data-target="#module_form" aria-expanded="false" aria-controls="module_form">Добавить модуль</button>
